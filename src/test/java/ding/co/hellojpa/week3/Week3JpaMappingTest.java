...
import ding.co.hellojpa.JpaMember;
import ding.co.hellojpa.JpaTeam;
    ...
    public class Week3JpaMappingTest {
        ...
        void 객체지향적인_JPA_매핑_체험() {
            ...
            try {
                ...
                // JPA가 알아서 team의 PK(id)를 꺼내서 MEMBER 테이블의 TEAM_ID(FK)로 저장합니다.
                member.setTeam(team);
                ...
                System.out.println("=== 2. 조회 시작 (객체 그래프 탐색) ===");
                // ==========================================
                // 2. [조회] 참조로 바로 꺼냄!
                // ==========================================
                ...
                // member.getTeam()을 호출하는 순간, 참조를 타고 넘어갑니다. (FK 조인 자동 처리)
                ...
                if ("JPA개발팀".equals(findTeam.getName())) {
                    System.out.println(">>> 🎉 성공! 참조만으로 연관된 데이터를 가져왔습니다.");
                }
