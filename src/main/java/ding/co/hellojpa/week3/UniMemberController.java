...
import ding.co.hellojpa.week3.MemberTeamDto;
import ding.co.hellojpa.week3.UniMemberService;
...
public class UniMemberController {
    ...
    public String getTeamNameError(@PathVariable Long id) {
        // 1. 서비스 호출 (트랜잭션 시작 -> 종료)
        // 반환된 member는 '준영속' 상태입니다. Team은 프록시(가짜)입니다.
    ...
    public String getTeamNameFetch(@PathVariable Long id) {
        // 서비스에서 이미 Team까지 Join 해서 가져왔음 (진짜 객체)
